...
function main(argv: string[]): number {
  ...
  if (args.svgOut) {
    writeFileSync(args.svgOut, renderSvg(report), "utf8");
    process.stderr.write(`wrote seismograph to ${args.svgOut}\n`);
  }
...
if (invokedPath.endsWith("cli.ts") || invokedPath.endsWith("cli.js")) {
